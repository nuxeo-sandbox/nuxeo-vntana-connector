...
public class TestVntanaGetViewerInfo {
    ...
    public void shouldCallTheOperation() throws OperationException {
        ...
        ctx.setInput(model);
        Blob blob = (Blob) automationService.run(ctx, VntanaGetViewerParams.ID);
        Assert.assertNotNull(blob);
        Assert.assertEquals("application/json",blob.getMimeType());
